...
namespace AgenciaDeViagens.Controllers
{
    ...
    public class FuncionarioController : Controller
    {
        ...
        {
            AreaDoFuncionarioViewModel vm = new();
        ...
        [HttpPost]
        public IActionResult AdicionarPacote(List<IFormFile> imagens, AreaDoFuncionarioViewModel vModel, DateOnly DataInicial, DateOnly DataFinal)
        {
            ...
            if (imagens != null && imagens.Count > 0)
            {
                foreach (var imagem in imagens)
                {
                    ...
                    novasImagens.Add(caminhoWeb); // esse vai para o banco ou modelo
                }
            }
            ...
            */
            ...
            if (!(DataFinal == default || DataInicial == default))
            {
